...
/**
 * @author : 桥下一粒砂 chenyoca@gmail.com date : 2012-7-21 电话工具类
 * 
 */
public class PhoneUtility {
	...
	public static void makeCall(Activity activity, String phoneNumber) {
		Intent dialIntent = new Intent(Intent.ACTION_CALL, Uri.parse(String
				.format("tel:%s", phoneNumber)));
		try {
			activity.startActivity(dialIntent);
		} catch (Exception e) {
			Toast.makeText(activity, "无法拨打电话！可能本应用拨打电话的权限被安全软件禁用，请您检查后重试。",
	...
	public static void sms(Activity activity, String receive, String content) {
		...
		try {
			...
			Toast.makeText(activity, "无法发送！可能本应用拨打电话的权限被安全软件禁用，请您检查后重试。",
	 ...
	 *            接收者，可以多个
	 */
	public static void mailTo(Activity activity, String subject,
			String content, String... receivers) {
