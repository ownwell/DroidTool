...
/**
 * @author : 桥下一粒砂 chenyoca@gmail.com date : 2012-11-13 Activity帮助器类
 */
public final class ActivityUtility {
	 ...
	 */
	public static void switchTo(Activity activity,
			Class<? extends Activity> target, Params params) {
	 ...
	 */
	public static void switchTo(Activity activity,
			Class<? extends Activity> targetActivity, Params params,
			int requestCode) {
	...
	public static void showAtCenter(final Activity activity,
			final String message, final boolean center) {
		final String msg = msgFilter != null ? msgFilter.filter(message)
				: message;
